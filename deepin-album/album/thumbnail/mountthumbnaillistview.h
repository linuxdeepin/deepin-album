 ...
 */
#ifndef MOUNTTHUMBNAILLISTVIEW_H
#define MOUNTTHUMBNAILLISTVIEW_H
...
class MountThumbnailListView : public DListView, public ImageEngineObject
{
    Q_OBJECT
...
public:
    ...
    explicit MountThumbnailListView(ThumbnailDelegate::DelegateType type = ThumbnailDelegate::NullType, QString imgtype = "All Photos", QWidget *parent = nullptr);
    ~MountThumbnailListView() override;
