...
Item {
    ...
    FloatingPanel {
        ...
        width: parent.width - 20 < toolBarThumbnailListView.btnContentWidth + toolBarThumbnailListView.listContentWidth + toolBarThumbnailListView.albumBtnWidth
               ? parent.width - 20
               : toolBarThumbnailListView.btnContentWidth + toolBarThumbnailListView.listContentWidth + toolBarThumbnailListView.albumBtnWidth
