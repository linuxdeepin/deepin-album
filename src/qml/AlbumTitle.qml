...
TitleBar {
    ...
    property int layoutLeftMargin_AlignLeft: showHideleftSidebarButtonArea.x + showHideleftSidebarButtonArea.width // 显示比例按钮向标题左侧对齐时的布局留白宽度
    ...
    FadeInoutAnimation {
        id: showHideleftSidebarButtonArea
        anchors {
            top: parent.top
            topMargin: 7
