...
- 單擊![icon_menu](../common/icon_menu.svg)> **匯入照片**。
...
> ![tips](../common/tips.svg)竅門：您也可以單擊介面右上角 **選擇**，選中多張照片，單擊介面上的按鈕 ![icon](../common/left.svg) 和 ![icon](../common/right.svg) 批次旋轉照片。
...
在主選單中，您可以[新增相簿](#新增相簿)、[匯入照片](#匯入照片)、切換視窗主題、查看說明手冊，了解相簿的更多資訊。
